...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-green-100 p-4">
      <div className="w-full max-w-5xl bg-white rounded-2xl shadow-xl border border-green-200 overflow-hidden flex flex-col md:flex-row">
        
        {/* Left section (only visible on md+) */}
        {/* <div className="hidden md:flex flex-1 flex-col items-center justify-center bg-green-100 p-10">
          <img
            src={NoteNestLogo}
            alt="NoteNest Logo"
          ...
          <h2 className="text-2xl font-bold text-green-800 text-center">
            Welcome to <span className="text-green-900">NoteNest</span>
          </h2>
          <p className="mt-4 text-green-700 text-center max-w-sm">
